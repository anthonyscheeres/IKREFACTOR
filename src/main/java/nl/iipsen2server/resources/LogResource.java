...
public class LogResource {
    ...
    public void createLogByUserId(LogModel l, @PathParam("id") int id) {
        log.createLog(l, id);
    }
    ...
    public String showAlllogsForAdmin(@PathParam("id") int id) throws Exception {
        return log.showlogsIfIdIsFromAnAdmin(id);
    }
